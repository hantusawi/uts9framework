...
class Pemain extends CI_Controller {
	...
	{
		$data['player']=$this->Club_Model->getPemainById($id);
		$this->load->view('pemain',$data);	
	}
	public function all()
	{
		$data['player']=$this->Club_Model->getPemainAll();
		$this->load->view('pemain',$data);	
	}
	public function addData($id) 
	{
		...
		if($this->form_validation->run()==FALSE){
			$data['player']=$this->Club_Model->getDataClub();
			$this->load->view('addPemain',$data);
		}
		else
		{
			$this->Pemain_Model->create();
	...
	public function edit($id) 
	{
		...
		if($this->form_validation->run()==FALSE){
			...
			$data['player']=$this->Club_Model->getPemain($id);
